...
public class Frame extends JFrame {
    ...
    public Frame(Model model) {
        ...
        mainPanel = new MainPanel(PREF_SIZE.width, PREF_SIZE.height);
        ...
        setVisible(true);
        /*mainPanel.setCanvasSize(PREF_SIZE.width - getInsets().right - getInsets().left, PREF_SIZE.height - getInsets().top - getInsets().bottom - toolBar.getHeight());
        mainPanel.setPreferredSize(new Dimension(PREF_SIZE.width - getInsets().right - getInsets().left, PREF_SIZE.height - getInsets().top - getInsets().bottom - toolBar.getHeight()));
        */pack();
    }
